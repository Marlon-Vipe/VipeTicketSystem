...
namespace VipeSystem.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Priority,Description")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Priority,Description")] Priority priority)
        {
            if (ModelState.IsValid)
            {
